...
(() => {
  ...
  style.textContent = `
    ...
    body.home-active .home-view { background: var(--bg); }
     body.home-active main { width: min(100%, 1360px); padding: 24px 24px 32px; overflow-x: hidden; }
    ...
    .home-view { display: none; width: 100%; max-width: 1360px; margin: 0 auto; padding: 0; color: #172033; background: var(--bg); overflow-x: hidden; }
