(() => {
  ...
  function ensureProtectionStyle() {
    ...
    style.textContent = `
      ...
      .fixa-streak-help-button{position:absolute;right:10px;top:0;width:38px!important;min-width:38px!important;max-width:38px!important;height:38px!important;min-height:38px!important;max-height:38px!important;inline-size:38px!important;block-size:38px!important;aspect-ratio:1/1!important;box-sizing:border-box!important;padding:0!important;border:1px solid #bfd4ff;border-radius:999px!important;display:inline-grid;place-items:center;background:#fff;color:#1d4ed8;font-size:16px;font-weight:850;line-height:1;box-shadow:0 2px 8px rgba(37,99,235,.08);cursor:pointer;transition:background .16s ease,border-color .16s ease,box-shadow .16s ease}
